...
ActiveRecord::Schema[8.1].define(version: 20_260_322_000_000) do
  ...
  create_table 'diagnoses', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[encounter_id icd10_code], name: 'index_diagnoses_on_encounter_id_and_icd10_code'
  ...
  create_table 'encounters', force: :cascade do |t|
    ...
    t.index %w[patient_id encountered_at], name: 'index_encounters_on_patient_id_and_encountered_at'
  ...
  create_table 'patients', force: :cascade do |t|
    ...
    t.virtual 'searchable_name', type: :tsvector,
                                 as: "to_tsvector('simple'::regconfig, (((COALESCE(first_name, ''::character varying))::text || ' '::text) || (COALESCE(last_name, ''::character varying))::text))", stored: true
    t.datetime 'updated_at', null: false
    t.bigint 'user_id'
    t.index %w[last_name first_name], name: 'index_patients_on_last_name_and_first_name'
  ...
  create_table 'vitals', force: :cascade do |t|
    ...
    t.index %w[encounter_id vital_type], name: 'index_vitals_on_encounter_id_and_vital_type'
