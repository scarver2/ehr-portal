...
RSpec.describe 'GraphQL', type: :request do
  ...
  describe 'providers query' do
    ...
    subject(:result) { gql('{ providers { id firstName lastName npi specialty clinicName } }') }
  ...
  describe 'provider query' do
    ...
    subject(:result) do
      gql(
        'query GetProvider($id: ID!) { provider(id: $id) { id firstName lastName fullName npi specialty clinicName } }',
