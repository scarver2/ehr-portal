...
// apps/ehr-portal/src/app/(app)/profile/profile-client.tsx
// Loaded only on the client (ssr: false) to avoid hydration mismatches,
// since all auth state comes from localStorage via context.
...
export default function ProfileClient() {
  ...
  return (
    <Protected>
      {user ? <ProfileContent user={user} /> : <LoadingSkeleton />}
    </Protected>
  )
}
